...
def build_paper_order(plan: Dict[str, Any]) -> Dict[str, Any]:
    ...
    base = {
        ...
        "policy_id": safe_str(plan.get("policy_id")),
        "active_expressions": plan.get("active_expressions") if isinstance(plan.get("active_expressions"), list) else [],
...
def build_live_order_record(plan: Dict[str, Any], response: Dict[str, Any], *, status: str) -> Dict[str, Any]:
    ...
    base = {
        ...
        "strategy": "weather_edge_v1",
        "strategy_instance": safe_str(plan.get("strategy_instance")),
        "config_id": safe_str(plan.get("config_id")),
        "source_strategy_instance": safe_str(plan.get("source_strategy_instance")),
        "strategy_id": safe_str(plan.get("strategy_id")),
        "strategy_family": safe_str(plan.get("strategy_family")),
        "policy_id": safe_str(plan.get("policy_id")),
        ...
        "decision_mode": safe_str(plan.get("decision_mode")),
        "execution_mode": safe_str(plan.get("execution_mode")),
        "entry_regime_head": safe_str(plan.get("entry_regime_head")),
        ...
        "maker_price_cap": to_float(plan.get("maker_price_cap"), 0.0),
        "maker_lifecycle_root_created_at_utc": safe_str(plan.get("maker_lifecycle_root_created_at_utc")),
        "maker_lifecycle_deadline_utc": safe_str(plan.get("maker_lifecycle_deadline_utc")),
        "maker_lifecycle_reprice_count": int(to_float(plan.get("maker_lifecycle_reprice_count"), 0.0)),
        "maker_last_reprice_stage": safe_str(plan.get("maker_last_reprice_stage")),
        "maker_state_schema_version": safe_str(plan.get("maker_state_schema_version")),
        "maker_observation_source": safe_str(plan.get("maker_observation_source")),
        "maker_forecast_curve_hash": safe_str(plan.get("maker_forecast_curve_hash")),
        "maker_forecast_source": safe_str(plan.get("maker_forecast_source")),
        "maker_reprice_decision_best_bid": to_float(plan.get("maker_reprice_decision_best_bid"), 0.0),
        "maker_reprice_decision_best_ask": to_float(plan.get("maker_reprice_decision_best_ask"), 0.0),
        "maker_reprice_decision_tick_size": to_float(plan.get("maker_reprice_decision_tick_size"), 0.0),
        "maker_replacement_max_quote_drift_ticks": to_float(plan.get("maker_replacement_max_quote_drift_ticks"), 0.0),
