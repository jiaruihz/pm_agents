...
def test_committed_production_spec_declares_current_live_control_plane():
    ...
    assert by_id["current_yes_core_carry_tiny_live_v2"].resolved_restart_script() == Path(
        ...
        "5ba155d68f0a2e54284c73626730adc4389105c2/scripts/ops/"
    ...
    assert dict(by_id["weather_market_books"].launch_environment) == {
        ...
        "WEATHER_MARKET_BOOKS_WS_SHARED_CAPTURE_DEMANDS": (
            ...
            "weather_data_feed_service_runtime/output/cross_no_v2_metar_v2/"
            "capture_demands.jsonl"
        ),
        "WEATHER_MARKET_BOOKS_WS_CAPTURE_MAX_TTL_MIN": "120",
        "WEATHER_MARKET_BOOKS_WS_CAPTURE_MAX_ACTIVE_TOKENS": "96",
    }
    cross_no_v2 = by_id["cross_no_v2_metar_v1"]
    assert cross_no_v2.execution_mode == "live"
    assert cross_no_v2.expected_live is True
    assert cross_no_v2.recovery_policy == "guarded_live"
    ...
    assert cross_no_v2.expected_health_contract() == {
        ...
        "code_identity": "72ae100620770811faa021454d1507b9c6f4309f",
        ...
        "source_stream_monitor_enabled": True,
    ...
    assert spec.release("cross_no_v2_metar").expected_repo_sha == (
        "72ae100620770811faa021454d1507b9c6f4309f"
    )
    ...
    assert spec.release("market_books").expected_repo_sha == (
        "3cc2155969482d72d97fc462e3f3f57e3f587d7e"
    )
    ...
    assert selective_maker.desired_state == "running"
