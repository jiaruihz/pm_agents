...
Usage:
    python3 scripts/analysis/copy_trade_thematic_scan.py
    python3 scripts/analysis/copy_trade_thematic_scan.py --themes crypto,tech
    python3 scripts/analysis/copy_trade_thematic_scan.py --market-limit 30 --min-holders 3
"""
