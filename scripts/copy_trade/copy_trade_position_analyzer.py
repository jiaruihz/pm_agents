...
Usage:
    python3 scripts/copy_trade/copy_trade_position_analyzer.py
    python3 scripts/copy_trade/copy_trade_position_analyzer.py --wallets 0xabc...,0xdef...
    python3 scripts/copy_trade/copy_trade_position_analyzer.py --status paper --top 10
"""
