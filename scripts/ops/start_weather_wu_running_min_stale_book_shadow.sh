...
TMUX_SOCKET="${WEATHER_WU_LOW_STALE_BOOK_TMUX_SOCKET:-weather-jrs}"
...
MARKET_PROXY="${WEATHER_WU_LOW_STALE_BOOK_MARKET_PROXY:-${WEATHER_DATA_FEED_MARKET_PROXY:-${WEATHER_PREDICT_MARKET_PROXY:-http://127.0.0.1:7897}}}"
