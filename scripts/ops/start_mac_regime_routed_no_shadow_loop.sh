...
SNAPSHOT_DIR="${REGIME_ROUTED_NO_SNAPSHOT_DIR:-$(weather_production_path "$PROJECT_DIR" strategy_paper_snapshot_dir)}"
OBSERVATION_CACHE="${REGIME_ROUTED_NO_OBSERVATION_CACHE:-$(weather_production_path "$PROJECT_DIR" observation_cache_path)}"
