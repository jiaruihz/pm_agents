...
HIGH_FREQUENCY_SOURCE_MIN_INTERVAL_SEC="${WEATHER_FAST_OBS_HIGH_FREQUENCY_SOURCE_MIN_INTERVAL_SEC:-jma_amedas=300 noaa_madis_hfmetar=300 fmi=300 mgm=300 ims_lod=300}"
