...
SHADOW_QUEUE = [
    {
        ...
        "priority": "low",
        "status": "superseded",
        "source_doc": "docs/analysis/2026-07/2026-07-27-current-yes-core-carry-overshoot-missing-mechanisms-v2.md",
        ...
        "notes": "Superseded: later native-lattice/core-offset replay found no stable incremental hazard alpha; retain only as historical lineage.",
    },
    {
        ...
        "notes": "Superseded after V3.1 trade failure and later fixed-denominator replay; do not schedule as a current shadow candidate.",
    },
    {
        ...
        "priority": "low",
        "status": "blocked",
        "source_doc": "docs/analysis/2026-07/2026-07-14-peak-runway-current-no-v1.md",
        ...
        "blockers_json": ["2026-07-14 expression-specific replay reversed the old non-PIT hypothesis; BUY_NO ROI -68.6% on 16 rows / 9 dates"],
        "notes": "Historical hypothesis only; do not schedule shadow or infer NO price from YES without a new preregistered mechanism.",
    },
    {
