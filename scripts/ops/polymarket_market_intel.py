...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build Polymarket market intel from comments and smart wallets.")
...
def main() -> None:
    ...
    result = run_market_intel_workflow(
    ...
    print(f"comment status: {summary.get('comment_status', '')}")
    print(f"observed bias: {float(summary.get('observed_bias', 0.0)):.4f}")
