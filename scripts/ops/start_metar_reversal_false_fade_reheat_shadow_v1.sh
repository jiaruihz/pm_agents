...
RUNTIME_DIR="${METAR_REVERSAL_RUNTIME_DIR:-$PM_RUNTIME_ROOT/weather_edge_v1/metar_reversal_false_fade_reheat_shadow_v1}"
LOG_FILE="$RUNTIME_DIR/shadow_tmux.log"
SNAPSHOT_DIR="${METAR_REVERSAL_SNAPSHOT_DIR:-$(weather_production_path "$PROJECT_DIR" strategy_paper_snapshot_dir)}"
OBSERVATION_CACHE="${METAR_REVERSAL_OBSERVATION_CACHE:-$(weather_production_path "$PROJECT_DIR" observation_cache_path)}"
