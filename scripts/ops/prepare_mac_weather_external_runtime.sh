...
usage() {
  cat <<'EOF'
Usage: scripts/ops/prepare_mac_weather_external_runtime.sh --volume /Volumes/WeatherRuntime [--apply] [--include-backups]
...
mkdir -p "$VOLUME/pm_agents" "$VOLUME/weather_data_feed_service_runtime"
