...
HEADS = {
    ...
    "h2_early_dislocation": {
        ...
        "display_name": "current YES heat-death H2 early-dislocation 5-share taker probe",
        "config_name": "heat-death H2 early dislocation fixed 5-share taker, ask 0.50-0.93",
        "min_ask": 0.50,
        "max_ask": 0.93,
        "total_shares": 5,
        "taker_shares": 5,
        "maker_shares": 0,
        "min_top_ask_shares": 5,
        "execution": "5-share fresh-book taker",
                    ...
                    json.dumps(
                        {
                            ...
                            "sizing": {
                                ...
                                "taker_shares": spec["taker_shares"],
                                "maker_shares": spec["maker_shares"],
                            },
                            "dedupe": "one submitted opportunity per city-target_date across H1/H2 family",
                            "max_orders_per_utc_day": 3,
                            "min_ask": spec["min_ask"],
                            "max_ask": spec["max_ask"],
                            "buffer_band_excluded": [0.93, 0.95],
                            "min_top_ask_shares": spec["min_top_ask_shares"],
        ...
        statements.append(
            (
                ...
                (
                    ...
                    1,
                    f"explicit user-approved forward probe head {head}; family city-day dedupe; promotion gates frozen in {PREREG_DOC}",
                    spec["config_id"],
                ),
            )
        )
