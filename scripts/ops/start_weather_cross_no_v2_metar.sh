...
MAX_OBSERVATION_DELAY_SEC="${WEATHER_CROSS_NO_V2_METAR_MAX_OBSERVATION_DELAY_SEC:-3600}"
MAX_STREAM_SILENCE_SEC="${WEATHER_CROSS_NO_V2_METAR_MAX_STREAM_SILENCE_SEC:-120}"
...
"$PROJECT_DIR/.venv/bin/python" - \
  ...
  "$MAX_OBSERVATION_DELAY_SEC" "$MAX_STREAM_SILENCE_SEC" \
...
(
    ...
    book_timeout_sec,
    stop_after_sec,
    max_observation_delay_sec,
    max_stream_silence_sec,
    enable_live,
    confirm_live,
...
actual = {
    ...
    "WEATHER_CROSS_NO_V2_METAR_MAX_OBSERVATION_DELAY_SEC": max_observation_delay_sec,
    "WEATHER_CROSS_NO_V2_METAR_MAX_STREAM_SILENCE_SEC": max_stream_silence_sec,
...
if [[ "$START_COLLECTOR" == "1" ]]; then
  ...
  cmd=(
    ...
    --max-observation-delay-sec "$MAX_OBSERVATION_DELAY_SEC"
    --max-stream-silence-sec "$MAX_STREAM_SILENCE_SEC"
