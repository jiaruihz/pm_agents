...
LOW_PRICE_YES_LOTTERY_NOTIONAL="${LOW_PRICE_YES_LOTTERY_NOTIONAL:-1.0}"
...
LOW_PRICE_YES_LOTTERY_DISABLE_LIVE_TOKEN_RESOLUTION="${LOW_PRICE_YES_LOTTERY_DISABLE_LIVE_TOKEN_RESOLUTION:-1}"
...
if [[ "${LOW_PRICE_YES_LOTTERY_LOOP_CHILD:-0}" != "1" ]]; then
  nohup env \
    ...
    LOW_PRICE_YES_LOTTERY_LIVE="$LOW_PRICE_YES_LOTTERY_LIVE" \
    LOW_PRICE_YES_LOTTERY_CONFIRM_LIVE="$LOW_PRICE_YES_LOTTERY_CONFIRM_LIVE" \
    LOW_PRICE_YES_LOTTERY_NOTIONAL="$LOW_PRICE_YES_LOTTERY_NOTIONAL" \
    LOW_PRICE_YES_LOTTERY_INTERVAL_SECONDS="$LOW_PRICE_YES_LOTTERY_INTERVAL_SECONDS" \
    LOW_PRICE_YES_LOTTERY_MIN_ASK="$LOW_PRICE_YES_LOTTERY_MIN_ASK" \
    LOW_PRICE_YES_LOTTERY_MAX_ASK="$LOW_PRICE_YES_LOTTERY_MAX_ASK" \
    LOW_PRICE_YES_LOTTERY_MIN_EDGE="$LOW_PRICE_YES_LOTTERY_MIN_EDGE" \
    LOW_PRICE_YES_LOTTERY_MAX_TAKER_CUSHION="$LOW_PRICE_YES_LOTTERY_MAX_TAKER_CUSHION" \
    LOW_PRICE_YES_LOTTERY_MIN_FEE_EDGE="$LOW_PRICE_YES_LOTTERY_MIN_FEE_EDGE" \
    LOW_PRICE_YES_LOTTERY_MAX_SNAPSHOT_AGE_HOURS="$LOW_PRICE_YES_LOTTERY_MAX_SNAPSHOT_AGE_HOURS" \
    LOW_PRICE_YES_LOTTERY_MIN_HOURS_TO_SETTLE="$LOW_PRICE_YES_LOTTERY_MIN_HOURS_TO_SETTLE" \
    LOW_PRICE_YES_LOTTERY_MAX_CANDIDATES="$LOW_PRICE_YES_LOTTERY_MAX_CANDIDATES" \
