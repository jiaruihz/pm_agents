...
SCREEN_SESSION="${WEATHER_HKO_LOCK_SCREEN_SESSION:-weather_hko_official_tminus1_no_live}"
...
MARKET_PROXY="${WEATHER_HKO_LOCK_MARKET_PROXY:-${WEATHER_DATA_FEED_MARKET_PROXY:-${WEATHER_PREDICT_MARKET_PROXY:-http://127.0.0.1:7897}}}"
