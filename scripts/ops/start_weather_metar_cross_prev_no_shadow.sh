...
METAR_CROSS_SIGNAL_INPUT="${METAR_CROSS_SIGNAL_INPUT:-source-events}"
METAR_CROSS_SOURCE_EVENTS_PATH="${METAR_CROSS_SOURCE_EVENTS_PATH:-$HOME/projects/weather_data_feed_service_runtime/output/source_events/latest.json}"
...
args=(
  ...
  --signal-input "$METAR_CROSS_SIGNAL_INPUT"
  --source-events-path "$METAR_CROSS_SOURCE_EVENTS_PATH"
