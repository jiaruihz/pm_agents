...
WS_EXECUTION_EVIDENCE_MIN_INTERVAL_SEC="${WEATHER_MARKET_BOOKS_WS_EXECUTION_EVIDENCE_MIN_INTERVAL_SEC:-10}"
WS_EXECUTION_EVIDENCE_CHECKPOINT_GRACE_SEC="${WEATHER_MARKET_BOOKS_WS_EXECUTION_EVIDENCE_CHECKPOINT_GRACE_SEC:-20}"
WS_EXECUTION_EVIDENCE_DAILY_BUDGET_BYTES="${WEATHER_MARKET_BOOKS_WS_EXECUTION_EVIDENCE_DAILY_BUDGET_BYTES:-1000000000}"
...
weather_jrs_tmux "$TMUX_SOCKET" new-session -d -s "$TMUX_SESSION" \
  "export WEATHER_DATA_FEED_SERVICE_DIR='$SERVICE_DIR' \
     ...
     WEATHER_MARKET_BOOKS_MINIMUM_CITIES='$MINIMUM_CITIES' \
...
if ! weather_jrs_tmux "$TMUX_SOCKET" new-window -d -t "=$TMUX_SESSION" -n ws \
  "export WEATHER_DATA_FEED_SERVICE_DIR='$SERVICE_DIR' \
     ...
     WEATHER_MARKET_BOOKS_WS_CAPTURE_DEMANDS='$WS_MARKET_CAPTURE_DEMANDS' \
     WEATHER_MARKET_BOOKS_WS_SHARED_CAPTURE_DEMANDS='$WS_SHARED_CAPTURE_DEMANDS' \
     WEATHER_MARKET_BOOKS_WS_CAPTURE_MAX_TTL_MIN='$WS_MARKET_CAPTURE_MAX_TTL_MIN' \
     WEATHER_MARKET_BOOKS_WS_CAPTURE_MAX_ACTIVE_TOKENS='$WS_MARKET_CAPTURE_MAX_ACTIVE_TOKENS' \
     ...
     WEATHER_MARKET_BOOKS_WS_EXECUTION_EVIDENCE_MIN_INTERVAL_SEC='$WS_EXECUTION_EVIDENCE_MIN_INTERVAL_SEC' \
     WEATHER_MARKET_BOOKS_WS_EXECUTION_EVIDENCE_CHECKPOINT_GRACE_SEC='$WS_EXECUTION_EVIDENCE_CHECKPOINT_GRACE_SEC' \
     WEATHER_MARKET_BOOKS_WS_EXECUTION_EVIDENCE_DAILY_BUDGET_BYTES='$WS_EXECUTION_EVIDENCE_DAILY_BUDGET_BYTES' \
