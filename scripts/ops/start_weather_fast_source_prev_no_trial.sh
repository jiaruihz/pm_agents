...
SOURCES="${WEATHER_FAST_PREV_NO_SOURCES:-jma_amedas singapore_mss fmi}"
LIVE_CITIES="${WEATHER_FAST_PREV_NO_LIVE_CITIES:-Tokyo}"
SHADOW_CITIES="${WEATHER_FAST_PREV_NO_SHADOW_CITIES:-Singapore Helsinki}"
MAX_SHARES_PER_TRADE="${WEATHER_FAST_PREV_NO_MAX_SHARES_PER_TRADE:-5}"
MAX_SHARES_PER_CITY_DAY="${WEATHER_FAST_PREV_NO_MAX_SHARES_PER_CITY_DAY:-5}"
MAX_NO_ASK="${WEATHER_FAST_PREV_NO_MAX_NO_ASK:-0.80}"
...
cmd=(
  ...
  --max-shares-per-city-day "$MAX_SHARES_PER_CITY_DAY"
...
echo "max_shares_per_city_day=$MAX_SHARES_PER_CITY_DAY"
