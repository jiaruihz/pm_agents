...
REGIME_ROUTED_NO_MIN_SOFT_WEIGHT_TO_ASK_RATIO="${REGIME_ROUTED_NO_MIN_SOFT_WEIGHT_TO_ASK_RATIO:-1}"
...
DEFAULT_OBSERVATION_CACHE="/Volumes/jrs/weather_data_feed_service_runtime/output/observations/latest.json"
...
args=(
  ...
  --min-soft-weight-to-ask-ratio "$REGIME_ROUTED_NO_MIN_SOFT_WEIGHT_TO_ASK_RATIO"
