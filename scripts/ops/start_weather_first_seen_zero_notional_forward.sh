...
command_string="$(
  ...
  printf " --source-events %q" "$RUNTIME_ROOT/output/source_events/sources.jsonl"
  printf " --forecast-curves %q" "$RUNTIME_ROOT/targeted_output/forecast_hourly_curves"
  printf " --forecast-enrichment %q" "$RUNTIME_ROOT/output/forecast_enrichment/forecast_enrichment.jsonl"
  printf " --paper-snapshots %q" "$RUNTIME_ROOT/targeted_output/paper_snapshots"
