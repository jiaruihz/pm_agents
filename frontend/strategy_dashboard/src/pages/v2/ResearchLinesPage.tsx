  ...
  return (
    <div className="page">
      <header className="page-head">
        <h1>研究证据</h1>
        <p className="page-sub">各策略线的前向证据登记册。CI 跨 0 即不是可 live 规则，只是 shadow 候选。</p>
      </header>
      ...
      {lines != null && lines.length > 0 && (
        <>
          ...
          <table className="data-table">
            <thead>
              <tr>
                <th>研究线</th><th>状态</th><th>holdout ROI</th><th>forward ROI</th>
                <th>CI</th><th>超额 vs 基线</th><th>够 gate?</th>
              </tr>
            </thead>
            <tbody>
              {rows.map((l) => (
                <tr key={l.line_id}>
                  ...
                  <td>{pct(l.excess_roi_vs_baseline)}</td>
