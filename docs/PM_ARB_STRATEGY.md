...
- PMM (`pmm/`) provides continuous liquidity with inventory-aware quoting.
- PM-Arb (`pm_arb_bot/`) only acts when the YES/NO invariant is violated enough to cover frictions.
