...
| [2026-06-10-side-band-forecast-regime-clean-test-v0.md](analysis/2026-06/2026-06-10-side-band-forecast-regime-clean-test-v0.md) | `snapshot` | yes | Side Band + Forecast Regime Clean Test v0：full opportunity 复现/推广 side-band 并叠加 forecast regime；旧形态历史赚过但 holdout/excess CI 不稳，三门不过，当前 verdict=inconclusive |
