...
| low_price_yes_lottery_tiny_live_v1 | refined low-price BUY_YES longshot：`edge>=0.20`、ask `0.05..0.20`、`dist>0`、每 city-date 一笔，fresh-book maker-first；2026-07-12 起 live sizing 恢复为固定 `5 shares`，旧 fixed-cash / price-tier / score-tier 继续作为 shadow telemetry；station-basis / p_cal / bracket-distance / book-state 同步记录 | **`live`（tiny-live forward probe）** | 用户 2026-07-02 批准微仓前向取证；2026-07-06..07-12 曾按 score tier 放大，但 live audit 显示 `model_p_yes` 严重高估且 forward 排序反转，故撤销 score 驱动的 live sizing、恢复固定 5 shares。2026-07-02..ECMWF 修复时刻的 ECMWF-assigned 城市行受 GFS fallback 污染，forward gate 需剔除或单独分层；核心风险仍是少数尾部命中驱动与成交质量；market-anchored residual / overshoot-aware 版本仅作独立 shadow 研究，不接 regime-routed NO runner | [1]-[4] pre_predict / forecast_quality · [selector refinement](analysis/2026-07/2026-07-02-low-price-yes-lottery-selector-refinement-v1.md) · [HeadA refinement](analysis/2026-07/2026-07-04-low-price-yes-heada-refinement-v1.md) · [score×dist sizing](analysis/2026-07/2026-07-06-low-price-yes-score-dist-sizing-v1.md) · [live audit](analysis/2026-07/2026-07-10-low-price-yes-heada-live-audit-v1.md) · [terminal distribution](analysis/2026-07/2026-07-11-heada-terminal-distribution-v1.md) |
