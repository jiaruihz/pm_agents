...
| core_carry_integrated_maker_v4 | Core Carry 同一 5-share sleeve：queue → 5m midpoint → 10m near-ask；max 2 reprices；METAR/forecast/rebracket event 失效；无 taker fallback | `implementation verified / not deployed` | 合并现有 maker、15m pullback 与 event-rescore 证据；修复 v3 stage 未持久化及 Jeddah replacement `0.78→0.64`。历史影响 1/4 v3 reprices，0 fill/0 realized PnL；收益仍需真实 forward | [4] · [integrated maker v4](analysis/2026-08/2026-08-12-core-carry-integrated-maker-v4.md) |
| core_carry_dual_maker_ab_v5 | Core Carry `10 taker + 5 staged maker + 5 static ask-2c/15m pullback maker`；两 maker 独立 lineage、共享 weather-state cancel；单信号 max 20、daily cost cap 仍 $100 | `live rollout target / alpha unconfirmed` | pullback 5-share 容量代理为 56 settled signals 中 7 conservative crossings、7/0、+$4.40；30m 反转为 -$3.65。真实 A/B 必须按 authenticated fills/queue/adverse selection 复评，不把 crossing 当 fill | [4] · [integrated maker v4 / dual-maker v5](analysis/2026-08/2026-08-12-core-carry-integrated-maker-v4.md) |
