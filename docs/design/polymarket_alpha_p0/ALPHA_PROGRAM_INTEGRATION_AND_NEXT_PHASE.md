...
Current consolidated status, including the authorized 2026-08-28 five-market
smoke sample, is maintained in `PROJECT_OVERVIEW_CURRENT.md`. The historical
WP6 authorization wording below remains the preregistered eight-case Gate R
program boundary; the five-market smoke did not complete or replace WP6.
...
GATE_R_WP2=COMPLETE
GATE_R_WP2_EVIDENCE=GATE_R_WP2-evidence-seal
GATE_R_WP3=COMPLETE
...
CONTROLLED_5_MARKET_SMOKE=PARTIAL_SUCCESS_STOPPED_AT_BLIND_PACKET_FROZEN
CONTROLLED_5_MARKET_SMOKE_EVIDENCE=GATE_R_MVP_5_MARKET_SAMPLE-evidence-seal
...
lifecycle and deterministic routing portion; WP2 has closed the independent
GLM-5.3 proposal, exact-source binding and bounded human patch portion; WP3 has
