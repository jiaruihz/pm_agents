...
> Last updated: 2026-06-17 Range RV forward shadow ablation and schema-v2 telemetry fields.
...
5. If Range RV continues, do not broaden threshold search or fit city-specific filters to the two bad forward days. Keep the default-WU shadow runner on, record schema-v2 diagnostic fields, and require more settled forward dates before considering any cost-band or calibration change for paper/live.
