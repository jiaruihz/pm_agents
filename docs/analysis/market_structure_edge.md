...
| `docs/analysis/2026-08/2026-08-10-pooled-weather-ladder-transport-readiness-v1.md` + `weather_model_evaluation/pooled_ladder_transport.py` | Amsterdam/Helsinki/Tokyo pooled event-first-seen audit through 2026-08-10；forward collector自03:23Z起 | 历史联合events=0不变，冻结M0–M3不拟合。共享`weather_source_event_ladder_transport_v1`已补上assigned-forecast empirical-error + source lower-bound的守恒full-lattice ΔP_weather，并由`weather_market_books` owner采集0/15/30/60s整梯books；首个Amsterdam事件四时点均22/22 books，order/fill=0 | current-evidence / FORWARD_COLLECTION_RUNNING / zero-notional data shadow / no-live-change |
