...
`ladder_mass_transport_v1` keeps its original time split and frozen choice: train 2026-05-19..07-10, development 07-11..21, M2 Ridge alpha100, and frozen historical validation 07-22..28. After repairing the narrow consumption view from raw `market_books/batches`, the once-scored 07-29..08-08 post-freeze forward contains 148,961 rungs / 19,375 snapshots / 11 dates / 47 cities.

The final state is `BRANCH_EXHAUSTED`. Forward M2 60m MSE is `0.00153961`; it does not beat M0, static kink, or the zero predictor `0.00152827`. Direction AUC is 0.5042 and accuracy does not beat always-nonpositive. Only 10/47 cities and 1/9 liquidity regimes improve versus M0; every leave-one-city-out pooled comparison fails.

The selector is not reversed: pair-relative markout is `+$110.8195`, 10/11 dates positive, while the sign-flipped control is `-$111.5485`. But crossing plus fee overwhelms the 1.1238c/pair move: 9,861 taker→taker rows lose `$273.0897`, ROI `-2.7087%`, CI `[-$341.009,-$216.073]`, with 11/11 dates and 47/47 cities losing. Maker-only prices lack real fill evidence and fail modest adverse-selection sensitivity. No runtime selector, candidate/intent, shadow, or live instance was created. Report: `docs/analysis/2026-08/2026-08-09-ladder-mass-transport-forward-through-aug8-v2.md`.
...
| `docs/analysis/2026-08/2026-08-09-ladder-mass-transport-forward-through-aug8-v2.md` + `weather_model_evaluation/ladder_mass_transport.py` | train 2026-05-19..07-10; development 07-11..21; frozen validation 07-22..28; post-freeze forward 07-29..08-08 | New forward fails M0/static/zero; pair ranking is not reversed but taker execution loses on 11/11 dates and 47/47 cities | current-evidence / BRANCH_EXHAUSTED / no-shadow |
...
8. `ladder_mass_transport_v1` is exhausted on the through-8/8 post-freeze forward. Do not add M2 thresholds or city/liquidity allowlists; the only next mechanism is real-trade/WS-queue/order-lifecycle order-flow response with candidate versus generic-maker fills on the same denominator.
