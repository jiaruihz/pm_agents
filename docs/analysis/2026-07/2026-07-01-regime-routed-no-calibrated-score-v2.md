...
- Frozen/live-like replay: `2026-05-20`..`2026-06-26`, rows `163`.
- Historical best-ask diagnostic: `2026-05-20`..`2026-06-26`, rows `283`.
- Raw frozen rows before label/ask filtering: `165` rows through `2026-06-28`; dropped rows `2`.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| expanding_walk_forward | logit_market_route | 86 | 19 | +50.0% | +46.3% | +49.5% | 0.258 | 0.709 |
| expanding_walk_forward | logit_mechanism_plus_heuristic_score | 86 | 19 | +50.0% | +47.2% | +55.2% | 0.264 | 0.735 |
| expanding_walk_forward | logit_mechanism_weather | 86 | 19 | +50.0% | +46.5% | +54.0% | 0.268 | 0.740 |
| expanding_walk_forward | logit_mechanism_weather_citybias | 86 | 19 | +50.0% | +47.3% | +55.8% | 0.264 | 0.735 |
| forward_2026-06-21_plus | logit_market_route | 14 | 6 | +42.9% | +47.9% | +54.2% | 0.240 | 0.673 |
| forward_2026-06-21_plus | logit_mechanism_plus_heuristic_score | 14 | 6 | +42.9% | +48.8% | +62.5% | 0.233 | 0.656 |
| forward_2026-06-21_plus | logit_mechanism_weather | 14 | 6 | +42.9% | +44.9% | +72.9% | 0.222 | 0.635 |
| forward_2026-06-21_plus | logit_mechanism_weather_citybias | 14 | 6 | +42.9% | +48.6% | +64.6% | 0.235 | 0.657 |
...
| expanding_walk_forward | logit_market_route | model_p_ge_ask_plus_05_size_probability | 19 | 13 | 16 | +42.1% | 0.238 | +0.435 | +96.3% | +0.8% | +190.3% | 6 |
| expanding_walk_forward | logit_market_route | model_p_ge_ask_size_probability | 22 | 15 | 18 | +50.0% | 0.262 | +0.436 | +103.1% | +22.7% | +182.4% | 6 |
...
| expanding_walk_forward | logit_mechanism_weather_citybias | model_p_ge_ask_size_probability | 20 | 15 | 15 | +50.0% | 0.280 | +0.511 | +100.6% | +15.6% | +185.6% | 6 |
...
| forward_2026-06-21_plus | logit_market_route | model_p_ge_ask_plus_05_size_probability | 4 | 4 | 4 | +25.0% | 0.253 | +0.439 | +11.4% | -100.0% | +257.0% | 3 |
| forward_2026-06-21_plus | logit_market_route | model_p_ge_ask_size_probability | 5 | 5 | 5 | +40.0% | 0.316 | +0.468 | +27.1% | -100.0% | +194.0% | 3 |
...
| forward_2026-06-21_plus | logit_mechanism_plus_heuristic_score | model_p_ge_ask_size_probability | 4 | 4 | 4 | +25.0% | 0.253 | +0.535 | +39.5% | -100.0% | +264.8% | 3 |
...
| forward_2026-06-21_plus | logit_mechanism_weather_citybias | model_p_ge_ask_size_probability | 4 | 4 | 4 | +25.0% | 0.253 | +0.540 | +44.4% | -100.0% | +267.7% | 3 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| expanding_walk_forward | logit_market_route | current_heuristic_score_over_ask_ge_1_size_score | 25 | 17 | 16 | +52.0% | 0.306 | +0.469 | +93.1% | +18.8% | +176.7% | 5 |
| expanding_walk_forward | logit_market_route | model_p_ge_ask_plus_05_size_current_score | 20 | 13 | 17 | +35.0% | 0.240 | +0.364 | +98.0% | -11.2% | +207.4% | 6 |
| expanding_walk_forward | logit_market_route | model_p_ge_ask_size_current_score | 28 | 15 | 21 | +42.9% | 0.314 | +0.345 | +93.5% | +6.3% | +176.6% | 5 |
| expanding_walk_forward | logit_mechanism_plus_heuristic_score | current_heuristic_score_over_ask_ge_1_size_score | 25 | 17 | 16 | +52.0% | 0.306 | +0.469 | +93.1% | +18.8% | +176.7% | 5 |
...
| expanding_walk_forward | logit_mechanism_weather_citybias | model_p_ge_ask_size_current_score | 29 | 15 | 18 | +48.3% | 0.337 | +0.373 | +81.1% | -0.5% | +166.6% | 4 |
| forward_2026-06-21_plus | logit_market_route | current_heuristic_score_over_ask_ge_1_size_score | 5 | 4 | 5 | +60.0% | 0.342 | +0.432 | +69.5% | -45.0% | +203.6% | 1 |
| forward_2026-06-21_plus | logit_market_route | model_p_ge_ask_plus_05_size_current_score | 4 | 4 | 4 | +25.0% | 0.253 | +0.277 | +13.4% | -100.0% | +297.2% | 3 |
| forward_2026-06-21_plus | logit_market_route | model_p_ge_ask_size_current_score | 6 | 5 | 6 | +33.3% | 0.349 | +0.279 | +11.8% | -100.0% | +218.0% | 3 |
| forward_2026-06-21_plus | logit_mechanism_plus_heuristic_score | current_heuristic_score_over_ask_ge_1_size_score | 5 | 4 | 5 | +60.0% | 0.342 | +0.432 | +69.5% | -45.0% | +203.6% | 1 |
...
| forward_2026-06-21_plus | logit_mechanism_plus_heuristic_score | model_p_ge_ask_size_current_score | 5 | 4 | 4 | +20.0% | 0.308 | +0.324 | -22.5% | -100.0% | +51.3% | 3 |
| forward_2026-06-21_plus | logit_mechanism_weather | current_heuristic_score_over_ask_ge_1_size_score | 5 | 4 | 5 | +60.0% | 0.342 | +0.432 | +69.5% | -45.0% | +203.6% | 1 |
...
| forward_2026-06-21_plus | logit_mechanism_weather_citybias | model_p_ge_ask_size_current_score | 5 | 4 | 4 | +20.0% | 0.308 | +0.324 | -22.5% | -100.0% | +51.3% | 3 |
