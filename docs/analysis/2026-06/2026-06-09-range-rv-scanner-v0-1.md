...
> generated_at_utc: `2026-06-08T17:01:57.360079+00:00`
...
- scanner input candidates: `2212` seen-complete rows; decision sets `635`; range rows `6240`; all-legs-eligible range rows `2218`.
...
|---|---:|---:|---|---:|---:|---:|---:|---:|---:|---|
| `mixed_single_allowed` | 4750 | 1490 | `single/long_range/edge>=0.2` | +51.7% | +44.8% | +9.6% | +24.8% | +25.0% | -100.0% | `PASS/PASS/PASS -> confirmed` |
| `single_only` | 1422 | 461 | `single/long_range/edge>=0.2` | +51.7% | +44.8% | +9.6% | +24.8% | +25.0% | -100.0% | `PASS/PASS/PASS -> confirmed` |
| `true_range_only` | 3328 | 1029 | `above_tail/long_range/edge>=0.15` | +16.3% | +8.0% | -11.8% | +27.7% | +4.9% | -100.0% | `FAIL/FAIL/PASS -> inconclusive` |
| `adjacent_only` | 1428 | 433 | `adjacent_3/long_range/edge>=0.15` | +13.8% | +5.7% | -0.5% | +10.0% | -6.8% | NA | `PASS/FAIL/FAIL -> inconclusive` |
| `tail_only` | 1900 | 596 | `above_tail/long_range/edge>=0.15` | +16.3% | +8.0% | -11.8% | +27.7% | +4.9% | -100.0% | `FAIL/FAIL/PASS -> inconclusive` |
| `inside_range_yes` | 565 | 179 | `adjacent_3/long_range/edge>=0.15` | +13.8% | +5.7% | -0.5% | +10.0% | -6.8% | NA | `PASS/FAIL/FAIL -> inconclusive` |
| `outside_range_no` | 2010 | 594 | `adjacent_3/short_range/edge>=0.2` | +4.1% | +2.0% | -0.9% | -4.2% | -2.3% | NA | `PASS/PASS/FAIL -> inconclusive` |

### Eligible-only Universe

| family | train rows | holdout rows | selected train rule | train ROI | train excess | train top5 removed ROI | holdout ROI | holdout excess | holdout top5 removed ROI | gates |
|---|---:|---:|---|---:|---:|---:|---:|---:|---:|---|
| `mixed_single_allowed` | 1164 | 1054 | `single/long_range/edge>=0.2` | +54.6% | +36.9% | -7.1% | +35.8% | +35.6% | -100.0% | `PASS/FAIL/PASS -> inconclusive` |
| `single_only` | 369 | 341 | `single/long_range/edge>=0.2` | +54.6% | +36.9% | -7.1% | +35.8% | +35.6% | -100.0% | `PASS/FAIL/PASS -> inconclusive` |
| `true_range_only` | 795 | 713 | `adjacent_3/long_range/edge>=0.15` | +29.1% | +18.2% | -100.0% | +26.0% | -1.0% | NA | `PASS/PASS/FAIL -> inconclusive` |
| `adjacent_only` | 330 | 291 | `adjacent_3/long_range/edge>=0.15` | +29.1% | +18.2% | -100.0% | +26.0% | -1.0% | NA | `PASS/PASS/FAIL -> inconclusive` |
| `tail_only` | 465 | 422 | `below_tail/long_range/edge>=0.2` | +14.4% | +8.0% | -75.5% | +2.8% | +10.8% | -100.0% | `FAIL/FAIL/PASS -> inconclusive` |
| `inside_range_yes` | 139 | 112 | `adjacent_3/long_range/edge>=0.15` | +29.1% | +18.2% | -100.0% | +26.0% | -1.0% | NA | `PASS/PASS/FAIL -> inconclusive` |
| `outside_range_no` | 464 | 431 | `above_tail/short_range/edge>=0.2` | +11.3% | +7.3% | +0.8% | -7.6% | -3.0% | -9.5% | `PASS/PASS/FAIL -> inconclusive` |
