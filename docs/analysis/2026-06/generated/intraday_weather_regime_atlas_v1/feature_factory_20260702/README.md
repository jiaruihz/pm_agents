...
- Generated at UTC: `2026-07-03T16:22:10+00:00`.
- DB fact built at UTC: `2026-07-03T14:46:54.265291+00:00`.
- Actual feature target-date range: `2026-07-02`..`2026-07-02` (1 active dates).
...
```json
{
  "fact_trades_max_built_at_utc": "2026-07-03T14:46:54.265291+00:00",
...
| Stage | Rows/count |
|---|---:|
| orderbook files seen | 81 |
| orderbook records seen | 1381 |
| ok orderbook records | 1326 |
| kept before hourly dedupe | 541 |
| feature rows after hourly dedupe/enrichment | 204 |
| date/city/hour state rows | 53 |
| complete core state rows | 43 |
| active dates | 1 |
| cities | 10 |
...
| `forecast_peak_hour_local` | 64.2% | 96.2% |
| `forecast_peak_delta_hours_local` | 64.2% | 96.2% |
| `forecast_values_hash` | 64.2% | 96.2% |
| `gfs_forecast_peak_hour_local` | 0.0% | 96.2% |
| `gfs_forecast_peak_delta_hours_local` | NA | 96.2% |
| `ecmwf_forecast_peak_hour_local` | 0.0% | 96.2% |
| `ecmwf_forecast_peak_delta_hours_local` | NA | 96.2% |
| `dwpf_now` | 100.0% | 100.0% |
| `relative_humidity_pct` | 100.0% | 100.0% |
| `wind_speed_kt` | 100.0% | 100.0% |
| `sky_cover_code` | 79.4% | 79.2% |
| `temp_trend_1h_f` | 100.0% | 100.0% |
| `current_yes_ask` | 90.7% | 84.9% |
| `d1_no_ask` | 94.1% | 86.8% |
| `d2_no_ask` | 76.0% | 67.9% |
| `target_yes_ask` | 52.0% | 86.8% |
| `final_winning_bracket` | 100.0% | 100.0% |

## Output Files

- Feature rows CSV: `docs/analysis/2026-06/generated/intraday_weather_regime_atlas_v1/feature_factory_20260702/reheat_feature_rows.csv`
- Date/city/hour coverage CSV: `docs/analysis/2026-06/generated/intraday_weather_regime_atlas_v1/feature_factory_20260702/coverage_by_date_city_hour.csv`
- JSON manifest: `docs/analysis/2026-06/generated/intraday_weather_regime_atlas_v1/feature_factory_20260702/summary.json`
