...
| M3 挂 mid−1c | 白名单 | 884 | 8.6% | 57.9% | −29.4% | −4.93 | 1/20 |
| M3 挂 mid−1c | 修复6城 | 153 | 9.8% | 73.3% | −4.4% | −0.29 | 8/10 |

乐观敏感性口径（50% 计入"保持 best bid 且有活动"的未穿越单）几乎不动结论：
M1 白名单 −11.5%、M3 白名单 −25.4%。
...
- 逆向选择直接可测：M1+M3 全部 136 笔白名单被动成交里，54 笔在成交时刻
