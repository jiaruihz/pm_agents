...
> generated_at_utc: `2026-06-14T07:12:08.173393+00:00`
...
- snapshot rows: `695`; YES rows `348`; YES events `51`.
- snapshot ts UTC: `2026-06-14T07:00:36Z` to `2026-06-14T07:00:36Z`.
- event_date rows: `{'2026-06-14': 614, '2026-06-15': 81}`.
- fact built at: `2026-06-14T07:08:13.936914+00:00`.
- CLOB fill coverage gate: `gate_pass=True`; fail_reasons `[]`.

### Mandatory 5-Line SQL Self-Check

```text
MAX(fact_built_at_utc) = 2026-06-14T07:08:13.936914+00:00
...
fact_signal_candidates coverage = {'rows': 29206, 'eligible': 9985, 'paper_ordered': 3766, 'live_filled': 348}
...
- Current paper/shadow candidates: `2`.
- Same-family threshold telemetry: `[{'threshold': 0.005, 'candidate_count': 2, 'top_candidates': [{'event_date': '2026-06-15', 'city': 'Austin', 'underround': 0.058, 'total_yes_ask_cost': 0.942, 'min_ask_size': 27.66, 'max_yes_spread': 0.033}, {'event_date': '2026-06-14', 'city': 'Atlanta', 'underround': 0.024, 'total_yes_ask_cost': 0.976, 'min_ask_size': 5.0, 'max_yes_spread': 0.026}]}, {'threshold': 0.01, 'candidate_count': 2, 'top_candidates': [{'event_date': '2026-06-15', 'city': 'Austin', 'underround': 0.058, 'total_yes_ask_cost': 0.942, 'min_ask_size': 27.66, 'max_yes_spread': 0.033}, {'event_date': '2026-06-14', 'city': 'Atlanta', 'underround': 0.024, 'total_yes_ask_cost': 0.976, 'min_ask_size': 5.0, 'max_yes_spread': 0.026}]}, {'threshold': 0.02, 'candidate_count': 2, 'top_candidates': [{'event_date': '2026-06-15', 'city': 'Austin', 'underround': 0.058, 'total_yes_ask_cost': 0.942, 'min_ask_size': 27.66, 'max_yes_spread': 0.033}, {'event_date': '2026-06-14', 'city': 'Atlanta', 'underround': 0.024, 'total_yes_ask_cost': 0.976, 'min_ask_size': 5.0, 'max_yes_spread': 0.026}]}]`.
...
- Live-equivalent paper baskets: `1`; stale/observation-only baskets `2`; max record age `1353.209` seconds.
- Live-equivalent settled exactly-one-winner baskets: `0`; ROI `None`.
- All-YES paper passed checks: `['clob_coverage_gate_pass', 'paper_ledger_exists', 'live_equivalent_paper_ledger_exists', 'current_guard_audit_has_allowed', 'dry_run_live_plan_available']`.
- All-YES monitor blockers: `['paper_baskets_not_live_equivalent', 'forward_settled_baskets_low', 'forward_settled_active_dates_low', 'forward_settlements_pending', 'forward_roi_not_ready', 'positive_basket_rate_not_ready', 'dry_run_executor_state_missing', 'dry_run_executor_plan_bridge_missing', 'live_executor_missing']`; pending by date `{'2026-06-14': 2, '2026-06-15': 1}`.
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---|---|
| 2026-06-15 | `Austin` | 8 | 0.942 | +5.8% | 27.66 | 0.033 | 4.710 | 0.290 | True | `` |
...
| 2026-06-14 | `Dallas` | 8 | 1.027 | -2.7% | 5.00 | 0.03 | 5.135 | -0.135 | False | `underround_below_threshold` |
| 2026-06-14 | `Taipei` | 6 | 1.028 | -2.8% | 19.90 | 0.038 | 5.140 | -0.140 | False | `underround_below_threshold` |
| 2026-06-14 | `Ankara` | 7 | 1.032 | -3.2% | 12.19 | 0.03 | 5.160 | -0.160 | False | `underround_below_threshold` |
...
- Current market state: latest snapshot has executable-looking baskets, led by Austin 2026-06-15, Atlanta 2026-06-14.
- Paper ledger state: `3` baskets recorded, `3` pending, `0` settled exactly-one-winner.
- Live-equivalent forward state: `1` baskets recorded within the `180.0` second TTL; stale paper observations remain useful for opportunity discovery but do not count toward live-prep forward evidence.
