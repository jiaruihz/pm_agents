...
- 部署：production checkout `/Users/deepsleep/projects/pm_agents_market_books_ws_v2_prod`，SHA `ffdaef4c`。首个真实Amsterdam KNMI event `2806118a092c...`（first-seen `2026-08-10T03:23:42.965986Z`）产生11档weather transport，ECMWF error sample 354，probability sum `1.0→1.0`、delta sum `0.0`；0/15/30/60s四份snapshot均11 markets、22/22 books complete，actual start offset分别3.858/15.956/30.037/60.229s。
