...
盈亏列采用 research replay：在该 checkpoint 以 NO ask taker 买 1 share，entry fee 使用官方 Weather
曲线，持有至结算；`fee 后 PnL = NO payout - NO ask - entry fee`。它不是 actual fill。

- 无条件在 44 个可评分 checkpoint 各买 1 share（会对同一 bracket 重复加仓）：26 胜 18 负，成本
  `$25.71974`，fee 后 PnL `+$0.28026`，ROI `+1.09%`。
- 只按模型方向 `P(NO) >= 50%` 买入：26 笔、26 胜，成本 `$24.05444`，fee 后 PnL
  `+$1.94556`，ROI `+8.09%`。这不是 market-residual 策略，只是方向诊断，而且包含大量 99c
  的极低收益重复买入。
- 正式 v2 规则要求 `P(NO) - NO ask - fee >= 2%`：0 笔，成本 `$0`，fee 后总 PnL `$0`。

下表只是从完整 44 行中选出的路径锚点，**没有过滤 99c 行**；完整逐 checkpoint 数字在 CSV：

| JMA 时刻 JST | 决策 JST | current | JMA °C | market mid | NO ask | v2 P(NO) | fee 后 edge | 最终 NO | 买 1 share NO fee 后 PnL |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| 10:30 | 10:44 | 31 | 30.8 | 99.65% | 99.9% | 99.52% | -0.385% | 赢 | +$0.00095 |
| 12:40 | 12:48 | 32 | 32.4 | 93.35% | 94.7% | 90.14% | -4.814% | 赢 | +$0.05049 |
| 13:40 | 13:47 | 33 | 34.2 | 95.00% | 98.0% | 95.19% | -2.903% | 赢 | +$0.01902 |
| 14:10 | 14:17 | 34 | 33.6 | 57.50% | 60.0% | 51.18% | -10.023% | 赢 | +$0.38800 |
| 14:50 | 14:57 | 34 | 34.3 | 77.50% | 79.0% | 65.85% | -13.982% | 赢 | +$0.20170 |
| 15:00 | 15:08 | 35 | 34.7 | 17.50% | 21.0% | 14.13% | -7.704% | 输 | -$0.21830 |
| 15:30 | 15:37 | 35 | 35.3 | 33.50% | 35.0% | 28.82% | -7.321% | 输 | -$0.36137 |
| 16:40 | 16:52 | 35 | 34.3 | 1.10% | 2.0% | 0.40% | -1.695% | 输 | -$0.02098 |
| 17:20 | 17:27 | 35 | 33.3 | 0.15% | 0.2% | 0.15% | -0.056% | 输 | -$0.00210 |
