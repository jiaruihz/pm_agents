...
| Tokyo | terminal full-ladder probability head 与 source-event execution head 分层；next-routine-METAR confirmation 只作连续特征，不冒充 final settlement | current-bracket v2 在8/4–9的255 checkpoint Brier `0.07673`劣于market `0.06897`，旧双边residual 9笔仅3胜、fee ROI`-16.48%`，expression rejected。第一性原理重构的`.7 cross + previous-NO market-consensus veto`固定规则在7/9–8/9为11笔/10日、11胜、fee PnL`+$3.91`、ROI`+7.65%`；但平均breakeven `92.90%`、Wilson胜率下界仅`74.12%`，且8/1–9不是untouched forward | 旧current-YES/NO residual不live；market-confirmed previous-NO从8/11后zero-notional冻结积累≥30个新settled dates，同时采pre-event及0/15/30/60s full ladder；先证明同分母market baseline与fee后稳定性再讨论live · [first-principles rebuild](analysis/2026-08/2026-08-02-tokyo-overshoot-market-residual-v2.md#2026-08-10-第一性原理重构market-confirmed-previous-no) · [three-way replay](analysis/2026-08/2026-08-06-tokyo-cross-0p5-0p7-model-three-way-replay-v1.md) |
